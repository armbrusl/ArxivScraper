...
if __name__ == "__main__":
    ...
    parser.add_argument("--mostS"  , default = 3        , help = "The number of most similar articles you want to see"                 , type=int)
    parser.add_argument("--savePDF", default = True     , help = "The number of most similar articles you want to see"                , type=bool)
